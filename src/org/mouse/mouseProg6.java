...
public class mouseProg6 {
	 public static void main(String[] args) throws InterruptedException {
		 ...
		 WebElement orcTraining = driver.findElement(By.xpath("//span[text()='Oracle (48)']"));
		 Actions actions1 = new Actions(driver);
		 actions1.moveToElement(orcTraining).perform();
		 
		 Thread.sleep(1000);
		 
		 
		 WebElement training = driver.findElement(By.xpath("//span[text()='SQL Certification Training']"));
